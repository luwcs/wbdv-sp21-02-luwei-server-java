package com.example.wbdvsp2102luweijava.controllers;

import com.example.wbdvsp2102luweijava.models.Widget;
import com.example.wbdvsp2102luweijava.services.WidgetService;
...
// The annotation make this class accessible through http
@RestController
@CrossOrigin(origins = "*")
